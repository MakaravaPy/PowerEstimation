# -*- coding: utf-8 -*-
"""
Created on Tue Aug 27 09:48:36 2019
...
def JointIteratedKalmanFilter(y,Sm,Yws,Vs,iterstop=50,accuracy=1e-9):
    ...
    w_est= -0.004*np.ones((n_up,t_f+1))        
    ...
    for k in range(1,t_f+1):
        ...
        while(est_error3 > accuracy) and (counter3 < 500):
            ...
            Hw = weight_jacobian(H, x_est[:,k-1])#shape(len(vol), n_up)
...
color = ['b', 'g', 'r', 'c', 'm', 'y','b', 'g']
for i,k in enumerate([2,3,4,6,7,9,10,11]):
